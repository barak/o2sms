package SMS::Send::IE::emobilesms;
...
SMS::Send::IE::emobilesms - SMS::Send emobilesms Driver
...
=head1 SYNOPSIS
  ...
  # Create a emobilesms sender
  my $send = SMS::Send->new( 'IE::emobilesms' 
  	_login    => '0851234567',
	_password => 's3cr3t',
  	);
...
SMS::Send::IE::emobilesms is a driver for L<SMS::Send>.

It is a simple wrapper around L<WWW::SMS::IE::emobilesms>.
